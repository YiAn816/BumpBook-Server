package com.myda.generator.controller;
...
import com.myda.generator.service.IGenTableService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"daily.zip\"");
