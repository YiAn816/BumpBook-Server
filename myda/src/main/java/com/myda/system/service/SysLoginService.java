package com.myda.system.service;
...
import com.myda.common.constant.Constants;
import com.myda.common.core.domain.event.LogininforEvent;
...
import com.myda.common.core.domain.model.XcxLoginUser;
import com.myda.common.enums.DeviceType;
import com.myda.common.enums.LoginType;
import com.myda.common.enums.UserStatus;
import com.myda.common.enums.UserType;
import com.myda.common.exception.user.CaptchaException;
import com.myda.common.exception.user.CaptchaExpireException;
import com.myda.common.exception.user.UserException;
import com.myda.common.helper.LoginHelper;
import com.myda.common.utils.DateUtils;
import com.myda.common.utils.MessageUtils;
import com.myda.common.utils.ServletUtils;
import com.myda.common.utils.StringUtils;
import com.myda.common.utils.redis.RedisUtils;
import com.myda.common.utils.spring.SpringUtils;
import com.myda.system.mapper.SysUserMapper;
...
public class SysLoginService {
    ...
    public String xcxLogin(String xcxCode) {
        ...
        JSONObject jsonObject = wxMiniApi.authCode2Session(appId, appSecret, xcxCode);
    ...
    private SysUser loadUserByOpenid(String openid) {
        ...
        SysUser user = this.userMapper.selectUserByOpenId(openid);
        if (ObjectUtil.isNull(user)) {
            log.info("登录用户：{} 不存在.", openid);
            SysUser sysUser = new SysUser();
            sysUser.setOpenId(openid);
            sysUser.setNickName("微信用户"+openid.substring(0,5));
            sysUser.setUserName("wechat");
